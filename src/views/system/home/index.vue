<template>
  <TyContainer>
    <TyAside :width="isFlod ? '50' : '210'" style="transition: width 0.5s">
      <TyMenu :isFold="isFlod" style="width: unset;" >
        <template #header>
          <div
            style="
              height: 50px;
        ...
        <TySubMenu>
          ...
          <TyMenuItem> menu1 </TyMenuItem>
          <TyMenuItem> menu2 </TyMenuItem>
          <TyMenuItem> menu3 </TyMenuItem>
        </TySubMenu>
        <TySubMenu>
          <template #icon>
        ...
        <TySubMenu>
          <template #icon>
            <TyIcon icon="ty-slideshow-3-fill"></TyIcon>
          </template>
          <template #title> Navigation3 </template>
          <TyMenuItem> menu1 </TyMenuItem>
          <TyMenuItem> menu2 </TyMenuItem>
        </TySubMenu>
      </TyMenu>
      ...
      <TyHeader height="70" class="tyAdmin-header">
        <div class="tyAdmin-header__content">
          <div class="tyAdmin-header__left">
            <span class="foldBtn">
              <TyIcon
                :icon="isFlod ? 'ty-indent-increase' : 'ty-indent-decrease'"
                size="20"
                @click="toFold"
              ></TyIcon>
            </span>
