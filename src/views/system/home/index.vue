<template>
  <TyContainer>
    <TyAside :width="isFlod ? '50' : '210'" style="transition: width 0.5s">
      <TyMenu :isFold="isFlod" style="width: unset;" v-model="menuNm" :option="option">
        <template #header>
          <div style="
              height: 50px;
              display: flex;
              ...
              align-items: center;
            ">
            <svg width="143px" height="24px" viewBox="0 0 143 24">
                ...
                <g id="\u753B\u677F" transform="translate(-26.000000, -14.000000)">
                  <g id="\u7F16\u7EC4-6\u5907\u4EFD" transform="translate(26.000000, 14.000000)">
                    <g id="\u7F16\u7EC4-3">
                      ...
                      <g id="\u7F16\u7EC4-2" transform="translate(76.300000, 15.000000)" fill="var(--color-text-1)">
                        <path
                    ...
                    <path
                      ...
                      id="arco.design" fill="var(--color-text-1)" fill-rule="nonzero"></path>
                  </g>
                </g>
              </g>
            </svg>
      ...
      <TyHeader height="70" class="tyAdmin-header">
        <div class="tyAdmin-header__content">
          <div class="tyAdmin-header__left">
            <span class="foldBtn">
              <TyIcon :icon="isFlod ? 'ty-indent-increase' : 'ty-indent-decrease'" size="20" @click="toFold"></TyIcon>
            </span>
            <TyBreadcrumb>
